...
a = Analysis(
    ['./tickeys/run.py', './tickeys/windowManager.py', './tickeys/GUI.py', './tickeys/soundPlayer.py', './tickeys/CLI', './tickeys/', './tickeys/', './tickeys/', './tickeys/', './tickeys/', './tickeys/', './tickeys/', './tickeys/', './tickeys/'],
    pathex=['./tickeys'],
#    binaries=[
